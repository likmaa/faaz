          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-6">
              {[
                {
                  label: 'Facebook',
                  href: 'https://www.facebook.com/profile.php?id=61590474045884',
                ...
                {
                  label: 'Instagram',
                  href: 'https://www.instagram.com/la.faaz/',
                ...
                {
                  label: 'LinkedIn',
                  href: 'https://www.linkedin.com/company/99499322/',
                ...
                {
                  label: 'YouTube',
                  href: 'https://www.youtube.com/@LAFAAZ-rh7el',
